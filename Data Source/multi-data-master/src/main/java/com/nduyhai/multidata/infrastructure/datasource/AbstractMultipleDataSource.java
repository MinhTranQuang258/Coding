...
public abstract class AbstractMultipleDataSource {
    ...
    protected EntityManagerFactoryBuilder createEntityManagerFactoryBuilder(final JpaProperties properties, final PersistenceUnitManager persistenceUnitManager) {
    ...
    protected LocalContainerEntityManagerFactoryBean buildEntityManager(final JpaProperties properties, final DataSource datasource) {
        ...
        return builder.dataSource(datasource).packages(this.entityPackage()).persistenceUnit(this.unitName()).build();
    }
